...
from engine import GOALS, SCOPES, DATA, load_catalog, visible_apps, recommend, contact_link, valid_url, data_question, readiness_message
...
Choose your goal and answer a few questions.
...
The finder matches your selected goal and, where relevant, the type of data you want to investigate to approved catalog rules. It does not interpret free-text requests or use an AI model.
